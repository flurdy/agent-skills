...
.PHONY: help check test lint-python clean-code security-scan validate-skills test-validate-skills test-assemble test-artifact-hygiene test-second-opinion test-trello-beads test-project-brief test-skill-pilot test-architect test-plan-to-backlog test-beads test-next test-handoffs test-pi-spend test-review-pr test-review-requests test-pr-feedback test-pr-feedback-actions test-git-pr-lifecycle test-rebase test-ready-to-merge test-ready-to-release test-thoughtbox test-release-ci test-release-order test-release-status test-today test-yesterday test-wrap-up test-watch-admin test-watch-pr-feedback test-watch-prs test-watch-release test-watch-review-requests test-watch-rollouts test-watch-protocols list doctor doctor-codex clean clean-dry-run apply apply-codex dry-run dry-run-codex
...
help:
	...
	@echo "make test-git-pr-lifecycle"
	@echo "make test-rebase"
	@echo "make test-ready-to-merge"
...
TEST_TARGETS := test-validate-skills test-assemble test-artifact-hygiene \
  ...
  test-git-pr-lifecycle test-rebase test-ready-to-merge test-ready-to-release test-release-ci test-release-order test-release-status \
...
test-thoughtbox:
	@bash skills/thoughtbox/tests/test-skill-contract.sh
